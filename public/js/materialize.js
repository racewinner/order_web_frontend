    ...
    _createClass(Dropdown, [{
      ...
      value: function _setupEventHandlers() {
        ...
        if (this.options.hover) {
          ...
          this.el.addEventListener('blur', this._handleMouseLeaveBound);
  ...
  var Sidenav = function (_Component8) {
    ...
    _createClass(Sidenav, [{
      ...
      value: function _animateSidenavIn() {
        ...
        if($(this.el).hasClass("right-aligned")) slideOutPercent = 1;   // added by YGS
      ...
      value: function _animateSidenavOut() {
        ...
        if($(this.el).hasClass('right-aligned')) endPercent = 1;
...
;(function ($) {
  ...
  var Carousel = function (_Component18) {
    ...
    function Carousel(el, options) {
      ...
      _this61.dim = _this61.itemWidth * 2 + _this61.options.padding * 2 || 1; // Make sure dim is non zero for divisions.
      ...
      _this61._scroll(_this61.offset);    // maksym

      if(_this61.options.autoCarousel.enable) {
        _this61.startAutoCarousel();
      }
    ...
    _createClass(Carousel, [{
      ...
      key: "startAutoCarousel",
      value: function startAutoCarousel() {
        let theThis = this;
        if(theThis._autoCarouselTimer) {
          clearInterval(theThis._autoCarouselTimer);
        }
        theThis._autoCarouselTimer = setInterval(function() {
          theThis.next();
        }, theThis.options.autoCarousel.interval);
      }
    },{
      key: "stopAutoCarousel",
      value: function stopAutoCarousel() {
      ...
      key: "pauseAutoCarousel",
      value: function pauseAutoCarousel(pauseTime) {
        if(this.options.autoCarousel.enable) {
          if(this._autoCarouselTimer) {
            clearInterval(this._autoCarouselTimer);
            this._autoCarouselTimer = null;
          }
        ...
        if(this._restartAutoCarouselTimer) {
          clearTimeout(this._restartAutoCarouselTimer);
        }
        this._restartAutoCarouselTimer = setTimeout(() => {
          this._restartAutoCarouselTimer = null;
      ...
      value: function _setupEventHandlers() {
        ...
        this._handleCarouselMouseOverBound = this._handleCarouselMouseOver.bind(this);
        this._handleCarouselMouseLeaveBound = this._handleCarouselMouseLeave.bind(this);
        ...
        this.el.addEventListener('mouseover', this._handleCarouselMouseOverBound);
        this.el.addEventListener('mousedown', this._handleCarouselTapBound);
        this.el.addEventListener('mousemove', this._handleCarouselDragBound);
        this.el.addEventListener('mouseup', this._handleCarouselReleaseBound);
        this.el.addEventListener('mouseleave', this._handleCarouselReleaseBound);
        this.el.addEventListener('mouseleave', this._handleCarouselMouseLeaveBound);
      ...
      value: function _removeEventHandlers() {
        ...
        this.el.removeEventListener('mouseover', this._handleRangeMouseOverBound);
        this.el.removeEventListener('mousedown', this._handleCarouselTapBound);
        this.el.removeEventListener('mousemove', this._handleCarouselDragBound);
        this.el.removeEventListener('mouseup', this._handleCarouselReleaseBound);
        this.el.removeEventListener('mouseleave', this._handleCarouselReleaseBound);
        this.el.removeEventListener('mouseleave', this._handleCarouselMouseLeaveBound);
      ...
      key: "_handleCarouselMouseOver",
      value: function _handleCarouselMouseOver() {
        if(this._autoCarouselTimer) {
          this.stopAutoCarousel();
        }
      }
    }, {
      key: "_handleCarouselMouseLeave",
      value: function _handleCarouselMouseLeave() {
        if(this.options.autoCarousel.enable) {
          this.startAutoCarousel();
        }
      }
      ...
      value: function _handleCarouselClick(e) {
        ...
        if (this.dragged) {
          ...
          var diff = this._wrap(this.current) - clickedIndex;
      ...
      value: function _handleResize(e) {
        if (this.options.fullWidth) {
          ...
          this.offset = this.current * 2 * this.itemWidth;
          this.target = this.offset;
      ...
      value: function _scroll(x) {
        ...
        var lastCenter = this.current;
        var numVisibleOffset = 1 / this.options.numVisible;

        this.offset = typeof x === 'number' ? x : this.offset;
        this.current = Math.floor((this.offset) / this.dim);
        delta = this.offset - this.current * this.dim;
        dir = delta < 0 ? 1 : -1;
        ...
        if (this.options.fullWidth) {
          ...
          // let dx = parseInt(this.options.paddingX);
          let dx = parseInt((this.options.paddingX + this.el.clientWidth - this.itemWidth * this.options.numVisible - this.options.padding * (this.options.numVisible - 1))/2);
          alignment = `translateX(${dx}px)`;
        ...
        if (this.showIndicators) {
          var diff = this.current % this.count;
        ...
        if (!this.noWrap || this.current >= 0 && this.current < this.count) {
          el = this.images[this._wrap(this.current)];
        ...
        for (i = 1; i <= this.count; ++i) {
          ...
          // Don't show wrapped items.
          if(!this.noWrap) {
            el = this.images[this._wrap(this.current + i)]; 
        ...
        // onCycleTo callback
        var $currItem = this.$el.find('.carousel-item').eq(this._wrap(this.current));
        if (lastCenter !== this.current && typeof this.options.onCycleTo === "function") {
      ...
      value: function _updateItemStyle(el, opacity, zIndex, transform) {
        ...
        el.style.opacity = 1;   // modified by maksym
      ...
      value: function _cycleTo(n, callback) {
        var diff = this.current % this.count - n;
  ...
  var FormSelect = function (_Component20) {
    ...
    _createClass(FormSelect, [{
      ...
      value: function _setupDropdown() {
        ...
        // Add caret
        var dropdownIcon = $('<svg class="caret" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M7 10l5 5 5-5z" fill="black"/><path d="M0 0h24v24H0z" fill="none"/></svg>');

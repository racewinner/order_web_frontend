...
>
    ...
    <div class="card-body p-2 d-flex">
        <div class="cart-item-image2">
            ...
            <div class="d-flex align-items-end ms-0 ms-sm-2 show-in-mobile">
        ...
        <div class="cart-item-btn-group-width2" style="display: flex; flex-direction: column; justify-content: space-between;">
            <button type="button" class="remove-item">
                <i class="bi bi-trash"></i>
            </button>

            <div class="d-flex align-items-end ms-0 ms-sm-2 show-in-desktop">
                <?php if($product->available['avail']) { ?>
                <!-- <div class="purchase-action d-flex align-items-center px-1 must-hide">
                    <i class="bi bi-dash minus-cart"></i>
                    <input class="form-control cart-quantity" value="<?= ''/*$product->cart_quantity ?? 0*/ ?>" />

...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
		...
		<script src="<?php echo base_url();?>js/jquery-ui-1.9.1" type="text/javascript" language="javascript" charset="UTF-8"></script>
        <style>
			...
			<div class="row">
				<div class="order-menu">
                     ...
                     <ul id="slide-out" class="sidenav">
                        ...
                        <li><a href="<?php echo base_url();?>clogin"><i class="material-icons">exit_to_app</i>United Ambient</a></li>
				...
				<div class="order-nav">
                            ...
                            <li class="menu-item"><a href="<?php echo base_url();?>clogin" class="first-link active">United Ambient</a></li>
                    ...
                    <ul id="tabs">
                        <li class="active">
                            <div class="tab__title">
                                <span class="h3">Manager Login</span>
                            </div>
							...
							<?php if (isset($validation) && $validation->getErrors()): ?>
                                ...
                                <ul class="tabs-content"><li class="active"><div class="tab__content">
                                    <p class="form-row form-row-wide">
                                        <label for='email'>Enter Your Account Name. <span class="red-text">*</span></label>
